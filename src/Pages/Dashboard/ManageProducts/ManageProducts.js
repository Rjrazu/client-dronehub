          ...
          <TableBody>
            {products.map((product) => (
              ...
              >
                ...
                <TableCell align="center" sx={style2}>{product.model}</TableCell>
                <TableCell align="center" sx={style2}>{product.price}</TableCell>
                <TableCell align="center"><img src={product.image} style={{ width: "5rem" }} alt="" /></TableCell>
                <TableCell align="center" sx={style2}>{`${product.description.slice(0, 50)}...`}</TableCell>
